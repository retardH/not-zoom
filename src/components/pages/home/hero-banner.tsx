...
const HomeHeroBanner = () => {
  ...
  return (
    <div className="h-[300px] w-full rounded-xl bg-hero bg-cover bg-no-repeat object-cover">
      <div className="flex h-full flex-col justify-between max-md:px-5 max-md:py-8 lg:p-12">
        <h2 className="glassmorphism w-fit max-w-[270px] rounded px-4 py-2 text-center text-base font-medium">
